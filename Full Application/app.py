...
def predict_datapoint():
    if request.method == 'GET':
        ...
        data = CustomData(
            ...
            # source=request.form.get('source'),
            # destination=request.form.get('destination'),
            # Duration_hours=request.form.get('dur_hr'),
            # Duration_mins=request.form.get('dur_min'),
            # Arrival_hour=float(request.form.get('arr_hr')),
            # Arrival_min=float(request.form.get('arr_min')),

            # Dep_hour=float(request.form.get('dep_hr')),
            # Dep_min=float(request.form.get('dep_min')),
            # Journey_month=float(request.form.get('journey_month')),
            # Journey_day=float(request.form.get('journey_date')),
